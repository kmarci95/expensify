...
var IndecisionApp = function (_React$Component) {
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function componentDidMount() {
      try {
        console.log("fetching data", JSON.parse(localStorage.getItem("options")));
    ...
    value: function render() {
      ...
      return React.createElement(
        "div",
        null,
        React.createElement(Header, { title: "Indecision", subTitle: subTitle }),
...
var Options = function Options(props) {
  var options = props.options.map(function (option, index) {
    return React.createElement(
      Option,
      { key: index, handleDeleteOption: props.handleDeleteOption },
      option
    );
  });
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      { onClick: function onClick(e) {
          return props.handleDeleteOption(props.children);
        } },
      "Remove"
    )
  );
